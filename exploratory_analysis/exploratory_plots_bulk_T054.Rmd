---
title: "Exploratory Plots - Bulk RNAseq - Region: DLPFC"
author: |
 | Juliana Beker Godoy
 | UFPR
 | Post graduate program in Bioinformatics
 | Curitiba, Brazil
date: "`r Sys.Date()`"
output:
...
Fonte: [Rush Alzheimer's Disease Center (RADC)](https://www.radc.rush.edu/docs/var/detail.htm?category=Clinical+Diagnosis&subcategory=Final+consensus+diagnosis&variable=cogdx )
...
# Save to PDF
pdf(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/diagnosis_sex_T054.pdf", width = 10, height = 6)
print(p1)
dev.off()

# Save to PNG
png(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/diagnosis_sex_T054.png", width = 3000, height = 1800, res = 300)
print(p1)
dev.off()
```
...
print(paste0("Media da idade de morte das mulheres: ",mean_baseline_f))
print(paste0("Desvio padrao: ",sd_baseline_f))
...
print(paste0("Media da idade de morte dos homens: ",mean_baseline_m))
print(paste0("Desvio padrao: ",sd_baseline_m))

mean_baseline = mean(pheno_DLPFC$age_bl, na.rm = T)
sd_baseline= sd(pheno_DLPFC$age_bl, na.rm = T)
print(paste0("Media da idade de entrada nos coortes: ",mean_baseline))
print(paste0("Desvio padrao: ",sd_baseline))

p2 <- ggplot(pheno_DLPFC, aes(x=age_bl, fill=msex)) +
  geom_histogram(bins = 25, colour='black', position = "stack") +
  labs(x="Idade de entrada nos coortes", y="Frequência de Voluntários") +
   scale_colour_manual(name="Sexo", values=c("0" = "#F4A582", "1"="#77AADD"), labels=c("0"="Feminino", "1"="Masculino")) +
  scale_fill_manual(name="Sexo", values=c("0" = "#F4A582", "1"="#77AADD"), labels=c("0"="Feminino", "1"="Masculino"))+
...
# Save to PDF
pdf(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/baseline_age_T054.pdf", width = 10, height = 6)
print(p2)
dev.off()

# Save to PNG
png(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/baseline_age_T054.png", width = 3000, height = 1800, res = 300)
print(p2)
dev.off()
```
...
print(paste0("Media da idade de morte das mulheres: ",mean_death_f))
print(paste0("Desvio padrao: ",sd_death_f))
...
print(paste0("Media da idade de morte dos homens: ",mean_death_m))
print(paste0("Desvio padrao: ",sd_death_m))

mean_death = mean(pheno_DLPFC$age_death, na.rm = T)
sd_death = sd(pheno_DLPFC$age_death, na.rm = T)
print(paste0("Media da idade de morte geral: ",mean_death))
print(paste0("Desvio padrao: ",sd_death))

p3 <- ggplot(pheno_DLPFC, aes(x=age_death, fill=msex)) +
  geom_histogram(bins = 25, colour='black', position = "stack") +
  labs(x="Idade de morte", y="Frequência de Voluntários") +
   scale_colour_manual(name="Sexo", values=c("0" = "#F4A582", "1"="#77AADD"), labels=c("0"="Feminino", "1"="Masculino")) +
  scale_fill_manual(name="Sexo", values=c("0" = "#F4A582", "1"="#77AADD"), labels=c("0"="Feminino", "1"="Masculino")) +
...
# Save to PDF
pdf(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/age_death_T054.pdf", width = 10, height = 6)
print(p3)
dev.off()

# Save to PNG
png(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/age_death_T054.png", width = 3000, height = 1800, res = 300)
print(p3)
dev.off()
```
...
print(paste0("Media de anos de educação formal das mulheres: ",mean_educ_f))
print(paste0("Desvio padrao: ",sd_educ_f))

mean_educ_m = mean(pheno_DLPFC[pheno_DLPFC$msex == "1", "educ"], na.rm = T)
sd_educ_m = sd(pheno_DLPFC[pheno_DLPFC$msex == "1", "educ"], na.rm = T)
print(paste0("Media de anos de educação formal dos homens: ",mean_educ_m))
print(paste0("Desvio padrao: ",sd_educ_m))

mean_educ = mean(pheno_DLPFC$educ, na.rm = T)
sd_educ = sd(pheno_DLPFC$educ, na.rm = T)
print(paste0("Media de anos de educação formal geral: ",mean_educ))
print(paste0("Desvio padrao: ",sd_educ))

p4 <- ggplot(pheno_DLPFC, aes(x = factor(msex, levels = c("0", "1"), labels = c("Feminino", "Masculino")), 
  ...
  labs(x = "Sexo", y = "Anos de educação formal") +
  scale_fill_manual(values = c("0" = "#F4A582", "1" = "#77AADD")) +
  theme_classic() +
  theme(legend.position = "none") +
  stat_compare_means(method = "t.test", label = "p.format", 
                     comparisons = list(c("Feminino", "Masculino")), 
                     bracket.size = 0.5, tip.length = 0.02)

print (p4)

# Save to PDF
pdf(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/educ_T054.pdf", width = 10, height = 6)
print(p4)
dev.off()

# Save to PNG
png(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/educ_T054.png", width = 1400, height = 1700, res = 300)
print(p4)
dev.off()
```

##  Years of education compared with cognitive global variable

```{r education_by_cognitive, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}

# regressão linear demonstrando a relação entre os anos de educação formal e o decaimento cognitivo

ggplot(pheno_DLPFC, aes(x = cogn_global_lv, y = educ)) +
  geom_point() +
  labs(x="Global cognitive function", y="Years of education") +
  stat_smooth() +
  stat_cor()
```
...
p4 <- ggplot(data = pheno_DLPFC, aes(x = race)) +
  ...
  scale_x_discrete(labels = c("1" = "Branco", 
                              "2" = "Negro ou afro-americano", 
                              "3" = "Índio americano ou nativo do Alasca",
                              "6" = "Outro")) +
  coord_flip() + 
  theme_classic()
...
# Save to PDF
pdf(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/race_T054.pdf", width = 10, height = 6)
print(p4)
dev.off()

# Save to PNG
png(file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/race_T054.png", width = 3000, height = 1800, res = 300)
print(p4)
dev.off()
```
...
```{r, APOE_diagnosis, echo = FALSE, message=FALSE, results='hide'}
...
```{r, TOMM40 frequency, echo = FALSE, message=FALSE, results='hide'}
...
```{r, TOMM40_diagnosis, echo = FALSE, message=FALSE, results='hide'}
...
# supplementary table
write.xlsx(pheno_suppl, file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/pheno_data_supp_material.xlsx", row.names = FALSE)

# Correspondence table btwn projid and new ids
write.xlsx(id_map, file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/id_map.xlsx", row.names = FALSE)
```
...
# Save xlsx
write.xlsx(summary_table, file = "C:/Users/beker/OneDrive/Documentos/Mestrado/GitHub/Cytokines/bulk_RNAseq/T054/summary_table_bulk.xlsx", row.names = FALSE)
